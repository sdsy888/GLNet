...
class Options():
    def __init__(self):
        ...
        # model and dataset
        parser.add_argument('--file_index_train',
                            type=str,
                            help='path to file_index of train split dataset')
        parser.add_argument('--file_index_val',
                            type=str,
                            help='path to file_index of val split dataset')
        parser.add_argument('--file_index_test',
                            type=str,
                            help='path to file_index of test split dataset')
        ...
        parser.add_argument(
            ...
            type=str,
            help=
            'path to store trained model files, no need to include task specific name'
        )
        parser.add_argument(
            '--log_path',
            type=str,
            help=
            'path to store tensorboard log files, no need to include task specific name'
        )
        parser.add_argument(
            '--task_name',
            type=str,
        ...
        parser.add_argument(
            ...
            choices=[1, 2, 3],
            help=
            'mode for training procedure. 1: train global branch only. 2: train local branch with fixed global branch. 3: train global branch with fixed local branch'
        )
        ...
        parser.add_argument('--sub_batch_size',
                            type=int,
                            default=6,
        ...
        parser.add_argument('--size_p',
                            type=int,
                            default=508,
                            help='size (in pixel) for cropped local image')
        parser.add_argument('--path_g',
                            type=str,
                            default="",
                            help='name for global model path')
        parser.add_argument('--path_g2l',
                            type=str,
                            default="",
                            help='name for local from global model path')
        parser.add_argument('--path_l2g',
                            type=str,
                            default="",
                            help='name for global from local model path')
        parser.add_argument('--lamb_fmreg',
                            type=float,
                            default=0.15,
